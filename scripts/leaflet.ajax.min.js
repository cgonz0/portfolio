...
<html lang="en">
  ...
  <title>leaflet-ajax/leaflet.ajax.min.js at gh-pages · calvinmetcalf/leaflet-ajax</title>
  <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">
  <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
  <meta property="fb:app_id" content="1401488693436528">

    
    <meta content="https://avatars2.githubusercontent.com/u/1128607?v=4&amp;s=400" property="og:image" /><meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="calvinmetcalf/leaflet-ajax" property="og:title" /><meta content="https://github.com/calvinmetcalf/leaflet-ajax" property="og:url" /><meta content="leaflet-ajax - plugin for leaflet for ajax" property="og:description" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTk2MjQ4NTM2OmRiNWMxYjcyM2MxNGZjOTMxZmVjMjgxYTE2OWVmYTg4MmQ3OTFiNzQ3NmFjZjNkZjAzNDNkMDc4NWIwZTQwMmU=--0320d76b3a83b4ff69eca040d997242277e1f2ed">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="C1C2:DEA5:37D5F7C:558163D:599A2F8F" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="C1C2:DEA5:37D5F7C:558163D:599A2F8F" name="octolytics-dimension-request_id" /><meta content="sea" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" /><meta content="12071781" name="octolytics-actor-id" /><meta content="cristina-g" name="octolytics-actor-login" /><meta content="71b6cc0d24358d32182ebc7370c93773de38eec76bd8aa6a8840e0191ff61150" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="cristina-g">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="">

    <meta name="enabled-features" content="UNIVERSE_BANNER">

  <meta name="html-safe-nonce" content="17bf9b6458657b4ba048fbc60a3824a5c3137930">
...
<ul class="d-flex user-nav list-style-none" id="user-links">
  <li class="dropdown js-menu-container">
      ...
      <a href="/notifications" aria-label="You have unread notifications" class="header-navlink notification-indicator tooltipped tooltipped-s js-socket-channel js-notification-indicator" data-channel="notification-changed:12071781" data-ga-click="Header, go to notifications, icon:unread" data-hotkey="g n">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    <a class="header-navlink name tooltipped tooltipped-sw js-menu-target" href="/cristina-g"
       aria-label="View profile and more"
       aria-expanded="false"
       aria-haspopup="true"
       data-ga-click="Header, show menu, icon:avatar">
      <img alt="@cristina-g" class="avatar" src="https://avatars3.githubusercontent.com/u/12071781?v=4&amp;s=40" height="20" width="20">
      <span class="dropdown-caret"></span>
    </a>
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        <div class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">cristina-g</strong>
        </div>

        <div class="dropdown-divider"></div>

        <a class="dropdown-item" href="/cristina-g" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a>
        <a class="dropdown-item" href="/cristina-g?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="r8xkKpfBb+b85m/0HqU93J6SSWY/AMHWn6mXQZWdfopLqmr+DrqWIPBO+5ujzdP617bHPR/CwWMM5Qs4Hc++bQ==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="NxrfaKWy0k0HaRH/O269/rLg3g8giDKtXenqLD3HwGjTfNG8PMkriwvBhZCGBlPY+8RQVABKMhjOpXZVtZUAjw==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="yTKU9KJSdbWFk5oc1uscxyUrsl4wqp4/LMZSRNYbE5CDjt3EWgKbogPN7o57y8IqkglxNBzstT8CcDhh9eqYew==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="6602440" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/calvinmetcalf/leaflet-ajax/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="qdUlhlUwOPUF3wczVFMyuxXzcy+TwvWOtZ7e6lI7l0DQ21wtr7lP/j6f9wUNPPVQa5uwtai1NEJL/nP0/fuUNw==" /></div>
      <button
        type="submit"
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/calvinmetcalf/leaflet-ajax/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="5TErqeQO7AHZZiQp8VEK/dFLYXcWYb4hLPdxMlbpK2Z9P4MSTwakjpBaoR3PBtH2xMjtDRQy5vHq4dsKmbD2sA==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          ...
          <div id="fork-destination-box" style="display: none;">
            ...
            <include-fragment src=""
                ...
                data-url="/calvinmetcalf/leaflet-ajax/fork?fragment=1">
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="commit-tease">
      ...
      <div>
        <img alt="@calvinmetcalf" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/1128607?v=4&amp;s=40" width="20" />
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <img alt="@calvinmetcalf" height="24" src="https://avatars1.githubusercontent.com/u/1128607?v=4&amp;s=48" width="24" />
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      ...
      <a href="/calvinmetcalf/leaflet-ajax/commits/gh-pages/dist/leaflet.ajax.min.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/calvinmetcalf/leaflet-ajax/edit/gh-pages/dist/leaflet.ajax.min.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="si/1uz0WYjySH+CINTkDqsHHrooawdixDIkLgRKqoQ/vZd8ROp0TaSy1f6nOZEDAL0+2kM7veB//mit4V1yLqA==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/calvinmetcalf/leaflet-ajax/delete/gh-pages/dist/leaflet.ajax.min.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="wEFRNQr182qqco5oXvH8gT42x1SMW1kG+Pqt8YG9pH6P2PU26qNMqKbyFvpd5jl6yOJ/wxyVCmXWxqnCWoco7A==" /></div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2017 <span title="0.15313s from unicorn-3368973224-wdmsx">GitHub</span>, Inc.</li>
